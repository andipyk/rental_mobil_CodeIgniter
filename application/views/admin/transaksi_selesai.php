...
?>" method="post">
	...
	<div class="form-group">
		...
		<select class="form-control" name="kostumer" disabled>
			...
			<option <?php if($t->transaksi_kostumer == $k->kostumer_id){echo "selected='selected'";} ?> value="
				<?php echo $k->kostumer_id;
?>">
...
?>
	...
	<div class="form-group">
		...
		<select class="form-control" name="mobil" disabled>
			...
			<option <?php if($t->transaksi_mobil == $m->mobil_id){echo "selected='selected'";} ?> value="
				<?php echo $m->mobil_id; ?>">
