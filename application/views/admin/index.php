			...
			<div class="panel-body">
				<div class="list-group">
					...
					<a href="#" class="list-group-item">
						<span class="badge">
							<?php if($m->mobil_status == 1){echo "Tersedia";}else{echo "Dirental";}
?>
						</span>
						<i class="glyphicon glyphicon-
user"></i>
				...
				<div class="text-right">
					<a href="<?php echo 
base_url().'admin/mobil' ?>">Lihat Semua Mobil
						<i class="glyphicon
glyphicon-arrow-right"></i>
					</a>
				</div>
			</div>
		</div>
...
user"></i>
				...
				<div class="text-right">
					<a href="<?php echo 
base_url().'admin/kostumer' ?>">Lihat Semua Kostumer
						<i class="glyphicon glyphicon-arrow-right"></i>
					</a>
				</div>
			</div>
	...
	<div class="col-lg-5">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">
					<i class="glyphicon glyphicon-sort"></i> Peminjaman Terakhir</h3>
			</div>
			<div class="panel-body">
...
?>
							<tr>
								<td>
									<?php echo 
date('d/m/Y',strtotime($t->transaksi_tgl)); ?>
								</td>
								<td>
									<?php echo 
date('d/m/Y',strtotime($t->transaksi_tgl_pinjam)); ?>
								</td>
								<td>
									<?php echo 
date('d/m/Y',strtotime($t->transaksi_tgl_kembali)); ?>
								</td>
								<td>
									<?php echo "Rp. 
".number_format($t->transaksi_harga)." ,-"; ?>
								</td>
							</tr>
							<?php } ?>
						</tbody>
				...
				<div class="text-right">
					<a href="<?php echo 
base_url().'admin/transaksi' ?>">Lihat Semua Transaksi
						<i class="glyphicon glyphicon-arrow-right"></i>
					</a>
				</div>
			</div>
